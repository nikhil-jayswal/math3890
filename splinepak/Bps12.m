...
% Interpolate Hermite data with a C^1 quadratic  Powell-Sabin-12 spline

% Read in a triangulation
[no,xo,yo,nto,TRI] = readtri;      %figure; triplot(TRI,xo,yo);

% Compute triangulation lists
...
% Compute the gradients at the vertices
der = franke2d(xo,yo);
z = der(:,1); zx = der(:,2); zy = der(:,3);

% Compute the Powell-Sabin-12 split and find the coefficients
tic
[x,y,v1,v2,v3,e1,e2,e3,ie1,ie2,tril,trir,c] =...        
 ps12(xo,yo,z,zx,zy,v1o,v2o,v3o,e1o,e2o,e3o,ie1o,ie2o,trilo,triro);
toc
