...
% Compute a least squares fit using a tensor-product spline
% Version of TPlsq that adds noise
...
% Evaluate the sigmoid function at the grid points to get the data
z = zeros(nd,ndw);
for i = 1:nd
 z(i,:) = f(t(i),tw);
end
