...
%% Plot 2nd derivative in northeast direction

% Evaluate the 2nd directional derivative on the grid
u = [1,1];
[xg,yg,gu] = valspdergridr(d,2,x,y,v1,v2,v3,e1,e2,e3,ie1,c,ng,u,...
    xmin,xmax,ymin,ymax);

% Plot the 2nd directional derivative
figure; surfl(xg,yg,gu'); colormap(copper); title('Second directional derivative')

%% Find and print minimal value of spline on grid

fprintf('The minimum value of the second directional derivative of the spline = %5.2e\n', min(min(gu)));
